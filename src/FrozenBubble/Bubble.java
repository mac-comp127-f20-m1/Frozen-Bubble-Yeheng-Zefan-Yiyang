/**
 * Create a single bubble with the input x position and y position of the upper left, the width, the
 * height, and the color.
 * 
 * The Bubble class extends the Ellipse, so it can be treated as a GraphicsObject, specifically
